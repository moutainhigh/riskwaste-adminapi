...
public class CustomerBizGenerator implements ApplicationRunner {
    // mysql数据库连接配置
    ...
    // biz项目路径
    private String bizProjectPath = "项目名-模块名称-biz";
...
//        scanner();
    ...
    private void bizGen() {
        ...
        gc.setServiceName("%sService"); // 服务接口
        gc.setServiceImplName("%sServiceImpl"); // 服务实现
        ...
        pc.setMapper("mapper");
        // 控制器用默认的 controller
        // 服务以及服务实现 用默认的 service service.impl
...
//              strategy.setTablePrefix(pc.getModuleName() + "_"); // 表前缀
    ...
    public static void main(final String[] args) {
        SpringApplication.run(CustomerBizGenerator.class, args);
    }
